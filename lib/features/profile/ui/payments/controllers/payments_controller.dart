...
class PaymentsController extends GetxController {
  ...
  void goToAddMtnMoneyPaymentMethod() {
    selectedMethod.value = PaymentMethod.mtn;
    _appNavigation.toNamed(ProfilePrivateRoutes.addMomoPaymentMethod, arguments: { "paymentMethod": PaymentMethod.mtn });
  }

  void goToAddOrangeMoneyPaymentMethod() {
    selectedMethod.value = PaymentMethod.orange;
    _appNavigation.toNamed(ProfilePrivateRoutes.addMomoPaymentMethod, arguments: { "paymentMethod": PaymentMethod.orange });
  }

  void goToAddCardPaymentMethod() {
    selectedMethod.value = PaymentMethod.card;
    _appNavigation.toNamed(ProfilePrivateRoutes.addCardPaymentMethod, arguments: { "paymentMethod": PaymentMethod.card });
  }
}
