...
import '../application/usecases/get_all_user_chatrooms.usecase.dart';
import '../application/usecases/get_chatroom_by_appointment_id.usecase.dart';
import '../application/usecases/get_all_chatroom_messages.usecase.dart';
...
class ChatDependencies {
  static void init() {
    ...
    Get.lazyPut(() => GetAllUserChatRoomsUseCase(Get.find()), fenix: true);
