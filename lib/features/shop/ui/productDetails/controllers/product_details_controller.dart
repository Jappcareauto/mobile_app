...
import 'package:jappcare/features/shop/application/command/get_review.command.dart';
import 'package:jappcare/features/shop/application/usecases/get_review.usecase.dart';
...
class ProductDetailsController extends GetxController {
  ...
  Future<void> getReview(productId) async {
    final result =
        await getReviewUseCase.call(GetReviewCommand(productId: productId));
    result.fold((e) {
